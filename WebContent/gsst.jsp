...
<html>
<head>
<title>G. Sec.Science and Tech.-VOTING - LNMIIT_ONLINE_VOTING_PORTAL</title>
...
<body class="contact">
	...
	session.setAttribute("fname", "GSST");
	...
	<article id="main">
		...
		<header class="container">
			...
			<h2 align="center">VOTING FOR GENERAL SECRETARY SCIENCE AND TECHNOLOGY</h2>
			<p></p>
		</header>
