...
<html>
<head>
<title>View_Election_Event- LNMIIT_ONLINE_VOTING_PORTAL</title>
...
<body class="contact">
	...
	<article id="main">
		...
		<header class="container">
			...
			<h2 align="center">View Election Event</h2>
			<p></p>
		</header>
		...
		<section class="wrapper style4 special container 75%">
			...
			<div class="content">
					...
					<!-- Session Code -->	
					<br/><input type="button" width=100 name="BACK" value="BACK" id="back" onclick="window.location = 'ceo.jsp';"/>
